...
public class MyLongSound  {

	private static final String TAG = MyLongSound.class.getSimpleName();
	...
	protected MyLongSound(Context context, int resourceId, boolean looping) {
